...
- [ ] #12 CmdOrCtrl+W closes a window on Windows, where measurement showed the menu item's own accelerator does not arrive — the app registers the chord itself, as it does for the other three. Linux was not measured for this and is recorded as unverified
<!-- AC:END -->
